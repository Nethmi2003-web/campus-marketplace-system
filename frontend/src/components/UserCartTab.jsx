      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-[#001f5c] rounded-[2.5rem] p-8 text-white shadow-2xl flex flex-col justify-between">
          ...
          <div className="mt-12 space-y-4">
             <button className="w-full py-5 bg-secondary text-white rounded-2xl font-black text-sm uppercase tracking-widest shadow-xl shadow-secondary/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2">
